...
public class MultiModelSmart_Elsa2 extends MultiModelSmart {
    ...
    public MultiModelSmart_Elsa2(float var1)
    {
        this(var1, Scale, Scale);
    }

    public MultiModelSmart_Elsa2(float var1, int var2, int var3)
    {
        ...
        Headwear = new Modchu_ModelRotationRenderer(this, 34, -3, Head);
        ...
        RightArm = new Modchu_ModelRotationRenderer(this, 42, 17, bipedRightShoulder);
        ...
        LeftArm = new Modchu_ModelRotationRenderer(this, 50, 17, bipedLeftShoulder);
        LeftArm.mirror = true;
        ...
        SideTailR.addBox(-4.5F, -5.5F, 1.7F, 1, 9, 2, var1);
        SideTailR.setRotationPoint(0.0F, 0.0F, 0.0F);

        SideTailL = new Modchu_ModelRotationRenderer(this, 58, 18, Head);
        SideTailL.mirror = true;
        SideTailL.addBox(4.5F, -5.5F, 1.7F, 1, 9, 2, var1);
        SideTailL.setRotationPoint(0.0F, 0.0F, 0.0F);

		eyeR = new Modchu_ModelRotationRenderer(this, 17, 0, Head);
		eyeR.addPlate(-3.0F, -4F, -4.01F, 2, 3, 0, var1);
		eyeR.setRotationPointLM(0.0F, 0.0F, 0.0F);
		eyeL = new Modchu_ModelRotationRenderer(this, 21, 0, Head);
		eyeL.addPlate(1.0F, -4F, -4.01F, 2, 3, 0, var1);
    ...
    public void setLivingAnimationsLM(EntityLiving entityliving, float f, float f1, float f2)
    {
        ...
        // ‚Ü‚Î‚½‚« from Aug,SR2
        float f3 = (float)(entityliving.ticksExisted + entityliving.entityId) * 0.01F; //ˆÊ‘Š
        float f4 = (float)(Math.sin(f3 * 3F) + Math.sin(f3 * 17F) + Math.sin(f3 * 37F) - 2.1F); //ƒpƒ‹ƒX—ñ
        if (f4 > 0) {
	...
	public void superSetRotationAngles(float f, float f1, float f2, float f3,
		...
		bipedRightArm.rotationPointY = bipedLeftArm.rotationPointY = 6.0F;
