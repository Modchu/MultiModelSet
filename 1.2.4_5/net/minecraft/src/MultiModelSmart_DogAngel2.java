...
public class MultiModelSmart_DogAngel2 extends MultiModelSmart {
    ...
    public MultiModelSmart_DogAngel2(float var1)
    {
        this(var1, Scale, Scale);
    }

    public MultiModelSmart_DogAngel2(float var1, int var2, int var3)
    {
		...
		Ahoge.setRotationPoint(0.0F, -8F, -4F);

		Skirt.isHidden=true;

		Skirt1 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt1.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt1.setRotationPoint(2.4F,-3F,-0.6F);

		Skirt2 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt2.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt2.setRotationPoint(2F,-3F,-1.2F);

		Skirt3 = new Modchu_ModelRotationRenderer(this, -4, 32, Skirt);
		Skirt3.addBoxLM(0F, 0F, 0F, 14, 4, 4,var1);
		Skirt3.setRotationPoint(0F,-4F,0F);

		Skirt4 = new Modchu_ModelRotationRenderer(this, -4, 32, Skirt);
		Skirt4.addBoxLM(0F, 0F, 0F, 14, 4, 4,var1);
		Skirt4.setRotationPoint(0F,-4F,0F);

		Skirt5 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt5.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt5.setRotationPoint(-2F,-3F,-1.2F);

		Skirt6 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt6.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt6.setRotationPoint(-2.4F, -3F, -0.6F);

		Skirt7 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt7.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt7.setRotationPoint(-2.4F,-3F,0.6F);

		Skirt8 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt8.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt8.setRotationPoint(-2F,-3F,1.2F);

		Skirt9 = new Modchu_ModelRotationRenderer(this, -4, 32, Skirt);
		Skirt9.addBoxLM(0F, 0F, 0F, 14, 4, 4,var1);
		Skirt9.setRotationPoint(0F,-4F,0F);

		Skirt10 = new Modchu_ModelRotationRenderer(this, -4, 32, Skirt);
		Skirt10.addBoxLM(0F, 0F, 0F, 14, 4, 4,var1);
		Skirt10.setRotationPoint(0F,-4F,0F);

		Skirt11 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt11.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
		Skirt11.setRotationPoint(2F,-3F,1.2F);

		Skirt12 = new Modchu_ModelRotationRenderer(this, -2, 32, Skirt);
		Skirt12.addBoxLM(0F, 0F, 0F, 12, 4, 4,var1);
	...
	public void setRotationAnglesLM(float f, float f1, float f2, float f3,
		...
		if (!firstPerson && !isInventory) {
			...
			Ahoge.rotateAngleY = MathHelper.cos(f2 * 0.2F
					+ MathHelper.cos(f2 * 0.05F) * 1.0F) * 0.2F;
